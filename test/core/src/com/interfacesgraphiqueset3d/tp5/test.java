...
public class test extends ApplicationAdapter {
    ...
    public void create() {
        ...
        Vector3 position_pixel_3d = viewport.unproject(position_pixel_ecran);

       //Créer un rayon
       Vector3 origin = camera.position;
       Vector3 direction = origin.sub(position_pixel_3d);
       Ray rayon = new Ray(origin, direction);

       
        // Calculer l'intersection entre la sphere1 et ray1
        Vector3 intersection = new Vector3();
        Boolean isIntersected =  Intersector.intersectRaySphere(rayon, center, radius, intersection);
